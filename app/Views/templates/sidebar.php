<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
        ...
        <div class="sidebar-brand-text mx-3">CMS - DESA</div>
    </a>
        ...
        <li class="nav-item <?= url_is('/admin/manage-user') || url_is('/admin/manage-user/un-verified') ? 'active' : '' ?>">
            ...
            <div id="users" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="/admin/manage-user">All Users</a>
                    <a class="collapse-item" href="/admin/manage-user/un-verified">Unverified</a>
                </div>
        </li>
    ...
    <?php if (session()->get('user_level') == 1 or (session()->get('user_level') == 2)) : ?>
        ...
        <li class="nav-item <?= url_is('/getah') || url_is('/getah/masuk') || url_is('/getah/di-proses') || url_is('/getah/selesai') ? 'active' : '' ?>">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#getah" aria-expanded="true" aria-controls="getah">
                <?php if (url_is('/getah/masuk')) : ?>
                    <i class="fas fa-envelope-open"></i>
                <?php elseif (url_is('/getah/di-proses')) : ?>
                    <i class="fas fa-spinner"></i>
                <?php elseif (url_is('/getah/selesai')) : ?>
                    <i class="fas fa-check-square"></i>
                <?php else : ?>
                    <i class="fas fa-list"></i>
                <?php endif; ?>
                <span>Daftar Getah</span>
            </a>
            <div id="getah" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="/getah">Daftar Getah</a>
                </div>
            </div>
        </li>
    <?php endif; ?>
